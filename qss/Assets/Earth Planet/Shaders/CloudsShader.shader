...
Shader "CloudsShader"
{
	Properties
	{
		...
		[ASEBegin]_CloudsBaseColor("Clouds BaseColor", Color) = (1,1,1,1)
		...
		[ASEEnd]_FlowSpeed("Flow Speed", Range( 0 , 1)) = 0.2
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _CloudsBaseColor;
			float4 _FlowMap_ST;
			float4 _DarkSideEmission;
			float _CloudMult;
			float _Size;
			float _FlowStrength;
			float _FlowSpeed;
			float _NormalValue;
			float _DarkSideContrast;
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord272 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_4_0_g4 = (( texCoord272 / _Size )).xy;
				...
				float2 temp_output_17_0_g4 = temp_cast_2;
				float mulTime22_g4 = _TimeParameters.x * _FlowSpeed;
				...
				float2 temp_output_4_0_g3 = (( texCoord272 / _Size )).xy;
				float2 temp_cast_7 = (_FlowStrength).xx;
				float2 temp_output_17_0_g3 = temp_cast_7;
				float mulTime22_g3 = _TimeParameters.x * _FlowSpeed;
				...
				float3 BaseColor = ( _CloudsBaseColor * _CloudMult ).rgb;
				float3 Normal = lerpResult253.rgb;
				float3 Emission = ( _DarkSideEmission * ( 1.0 - clampResult43 ) ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = _CloudSmoothness;
				float Occlusion = 1;
				float Alpha = ( lerpResult9_g3 * clampResult257 ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 clampResult43 = clamp( CalculateContrast(_DarkSideContrast,temp_cast_1) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				
				float2 texCoord272 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_4_0_g3 = (( texCoord272 / _Size )).xy;
				float2 uv_FlowMap = IN.ase_texcoord3.xy * _FlowMap_ST.xy + _FlowMap_ST.zw;
				float4 tex2DNode275 = tex2D( _FlowMap, uv_FlowMap );
				float2 temp_cast_4 = (_FlowStrength).xx;
				float2 temp_output_17_0_g3 = temp_cast_4;
				float mulTime22_g3 = _TimeParameters.x * _FlowSpeed;
				float temp_output_27_0_g3 = frac( mulTime22_g3 );
				float2 temp_output_11_0_g3 = ( temp_output_4_0_g3 + ( -(tex2DNode275.rg*2.0 + -1.0) * temp_output_17_0_g3 * temp_output_27_0_g3 ) );
				float2 temp_output_12_0_g3 = ( temp_output_4_0_g3 + ( -(tex2DNode275.rg*2.0 + -1.0) * temp_output_17_0_g3 * frac( ( mulTime22_g3 + 0.5 ) ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 tex2DNode275 = tex2D( _FlowMap, uv_FlowMap );
				float2 temp_cast_2 = (_FlowStrength).xx;
				float2 temp_output_17_0_g3 = temp_cast_2;
				float mulTime22_g3 = _TimeParameters.x * _FlowSpeed;
				float temp_output_27_0_g3 = frac( mulTime22_g3 );
				float2 temp_output_11_0_g3 = ( temp_output_4_0_g3 + ( -(tex2DNode275.rg*2.0 + -1.0) * temp_output_17_0_g3 * temp_output_27_0_g3 ) );
				float2 temp_output_12_0_g3 = ( temp_output_4_0_g3 + ( -(tex2DNode275.rg*2.0 + -1.0) * temp_output_17_0_g3 * frac( ( mulTime22_g3 + 0.5 ) ) ) );
...
WireConnection;282;0;123;0
WireConnection;282;1;253;0
WireConnection;282;2;126;0
WireConnection;282;4;119;0
WireConnection;282;6;256;0
ASEEND*/
//CHKSM=35DDA568516957AE1197A60F217665089DDD1D56